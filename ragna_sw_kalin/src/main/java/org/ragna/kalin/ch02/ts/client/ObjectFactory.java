 ...
 * generated in the org.ragna.kalin.ch02.ts.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTimeAsStringResponse_QNAME = new QName("http://ts.ch02.kalin.ragna.org/", "getTimeAsStringResponse");
    private final static QName _GetTimeAsString_QNAME = new QName("http://ts.ch02.kalin.ragna.org/", "getTimeAsString");
    private final static QName _GetTimeAsElapsed_QNAME = new QName("http://ts.ch02.kalin.ragna.org/", "getTimeAsElapsed");
    private final static QName _GetTimeAsElapsedResponse_QNAME = new QName("http://ts.ch02.kalin.ragna.org/", "getTimeAsElapsedResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.ragna.kalin.ch02.ts.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.ch02.kalin.ragna.org/", name = "getTimeAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.ch02.kalin.ragna.org/", name = "getTimeAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.ch02.kalin.ragna.org/", name = "getTimeAsElapsed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.ch02.kalin.ragna.org/", name = "getTimeAsElapsedResponse")
